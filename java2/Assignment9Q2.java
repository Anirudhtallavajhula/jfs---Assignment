...
public class Assignment9Q2 {
    public static int maxComments(List<News> news) {
        ...
        return newsid.stream()
                .reduce(BinaryOperator.maxBy(Comparator.comparing(o -> Collections.frequency(newsid, o)))).orElse(0);
    }
    ...
    public static void main(String[] args) {
        ...
        feb23.add(new News(1, "Anirudh", "Tallavajhula", "comment"));
        feb23.add(new News(2, "Sachin", "Tendulkar", "comment"));
        feb23.add(new News(3, "Kohli", "Virat", "budget"));
        feb23.add(new News(1, "Dhoni", "MS", "budget "));
        feb23.add(new News(2, "Bumrah", "Jasprith", "budget"));
        feb23.add(new News(3, "Pant", "Rishab", "costly"));
