...
public class Assignment9Q3 {
    ...
    public static void main(String[] args) {
        ...
        t.add(new Trader("Anirudh", "Hyderabad"));
        t.add(new Trader("Sachin", "Mumbai"));
        t.add(new Trader("Rohit", "Mumbai"));
        t.add(new Trader("Kohli", "Delhi"));
        t.add(new Trader("Pant", "Indore"));
        t.add(new Trader("Bumrah", "Indore"));
