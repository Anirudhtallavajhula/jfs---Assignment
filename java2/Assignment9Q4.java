...
public class Assignment9Q4 {
    ...
    public static void main(String[] args) {
        // Adding few Traders
        Trader t1 = new Trader("Anirudh", "Hyderabad");
        Trader t2 = new Trader("Sachin", "Mumbai");
        Trader t3 = new Trader("Rohit", "Mumbai");
        Trader t4 = new Trader("Kohli", "Delhi");
        Trader t5 = new Trader("Dhoni", "Pune");
        Trader t6 = new Trader("Bumrah", "Indore");
